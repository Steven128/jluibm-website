...
(function(window, undefined) {
    ...
    $.fn.tableExport = function(options) {
        ...
        this.each(function() {
            ...
            function checkCaption(exportButton) {
                var $caption = $el.parent().parent().parent().find(".title");
            ...
            function createObjButton(dataObject, myContent, myClass) {
                var exportButton = "<button data-fileblob='" + dataObject + "' class='title-right " + bootstrapClass + bootstrapTheme + myClass + "'>" + myContent + "</button>";
    ...
    $(document).on("click", "button[data-fileblob]", function() {
    ...
    function export2file(data, mime, name, extension) {
        ...
        saveAs(new Blob([data], { type: mime + ";" + $.fn.tableExport.charset }),
            name + extension);
    }
