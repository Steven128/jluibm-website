    ...
    Plugin.prototype = {
        ...
        setup: function(table, tableSortContainer) {
            ...
            function setUpScroll() {
                ...
                $(window).on('resize', function() {
                    ...
                    tableSortContainer.css('width', 'auto');
                    initScroll();
                });
            }
        ...
        search: function(table, tableSortContainer) {
            ...
            if (table.hasClass('table-sort-search')) {
                ...
                var search = $('<div class="table-sort-search-container title-right"><input class="table-sort-search-input" type="text" placeholder="搜索"></div>');
                ...
                table.parent().parent().parent().parent().find(".title").append(search);
